...
var teamsDetails = JSON.parse(localStorage.getItem("teamArray"));
var playersDetails = JSON.parse(localStorage.getItem("playerArray"));
...
function makethisinclick(res){
  window.open(`./player.html?name=${res}`,"_self")
}
